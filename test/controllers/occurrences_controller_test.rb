...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post occurrences_url, params: { occurrence: { ServiceStation_id: @occurrence.ServiceStation_id, amount: @occurrence.amount, finalTime: @occurrence.finalTime, occurrenceNature_id: @occurrence.occurrenceNature_id, startTime: @occurrence.startTime } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { ServiceStation_id: @occurrence.ServiceStation_id, amount: @occurrence.amount, finalTime: @occurrence.finalTime, occurrenceNature_id: @occurrence.occurrenceNature_id, startTime: @occurrence.startTime } }
